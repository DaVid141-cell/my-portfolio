...
export default function Project() {
    return(
        <section id="projects" className="max-w-[1350px] mx-auto px-[20px] py-[75px] ">
            <ScrollAnimation>
                <div className="">
                        ...
                        <div className="grid grid-cols-2 gap-4 ">
                            <div className="grid grid-cols-subgrid p-4 rounded-lg bg-white/10 backdrop-blur-md border border-white/20 shadow-lg">
                                <img className="rounded-lg" src="images/budo.png"></img>
                                <div className=" p-2 ">
                             ...
                             <div className="grid grid-cols-subgrid p-4 rounded-lg bg-white/10 backdrop-blur-md border border-white/20 shadow-lg">
                                <img className="rounded-lg" src="images/enomy-finance.png"></img>
                                <div className="p-2">
                             ...
                             <div className="grid grid-cols-subgrid p-4 rounded-lg bg-white/10 backdrop-blur-md border border-white/20 shadow-lg">
                                <img className="rounded-lg" src="images/meals-on-wheels.png"></img>
                                <div className=" p-2">
                             ...
                             <div className="grid grid-cols-subgrid p-4 rounded-lg col-start-2 bg-white/10 backdrop-blur-md border border-white/20 shadow-lg    ">
                                <img className="rounded-lg" src="images/jumpstart-fashion.png"></img>
                                <div className="p-2">
